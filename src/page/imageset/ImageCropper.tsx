...
import { Box, Button, Container, Divider, IconButton, ImageList, ImageListItem, MenuItem, Paper, Select, Slider, TextField } from "@mui/material";
...
import { FilterState, loadConcept, updateImages } from "../../app/conceptSlice";
  ...
  return (<Container fixed maxWidth="xl">
    <Paper elevation={3}>
      ...
      <Box sx={{ maxHeight: height, height: height, overflowY: 'scroll', overflowX: 'hidden' }} >
        {currentFilter.images.length > 0 ? <ImageList variant="masonry" cols={column} gap={6} style={{ marginTop: 0, overflowX: 'hidden' }} >
          {
