import { Backdrop, Box, CircularProgress, Container, Divider, IconButton, MenuItem, Paper, Select, Slider, Toolbar, Tooltip } from "@mui/material";
...
function Tool({
  imageset_name, concept_name, is_regular, repeat,
}: {
  ...
  const currentFilter = { name: '', images: [] };
